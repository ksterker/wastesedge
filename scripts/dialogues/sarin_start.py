...
class sarin_start:
	...
	def __init__(self, p, n):
		...
		self.dialogue = [self.start, self.answer1, self.answer3, self.answer4, self.answer5, self.answer7, self.answer9, self.answer11, None]
