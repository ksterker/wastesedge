...
class demo_intro_1:
	...
	def __init__(self, p, n):
		...
		self.dialogue = [self.start, self.answer1, self.answer3, self.answer4, self.answer6, self.answer7, self.answer8, self.answer9, self.answer11, self.answer12, self.answer14, self.answer17, self.answer21, self.answer22, self.answer23, self.answer26, self.answer27, self.answer29, None]
