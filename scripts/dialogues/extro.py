...
class extro:
	loop = []
	strings = ["What is going on here? What are all these people doing in my room? Are you behind this, Half-Elf? I demand an explanation!", "Please calm down Master Fingolson. We are here to sort out this business once and for all.", "Sort this business out? Good ... good! It's about time, I'd say! So ... will that foul Elf finally return my Catseyes? I hear one was found amongst her belongings. And where there is one, the others shouldn't be far.", "I fear you are mistaken my good Dwarf. Neither were any Catseyes amongst your merchandise, nor am I in posession of your \"precious\" gems.", "As if an ignorant like you could tell the difference! I ...", "Silence! I have enough of your endless quarrel! I assume that $name here has poked around long enough in this pile of crap to produce the thief. He better had! So Half-Elf, go on, do your duty! End this bloody foolery!", "Uh, well, it's a fact that Lady Silverhair cannot be the thief.", "I think the thief tried to frame Lady Silverhair.", "I'm sorry, I have no idea as to who the thief might be.", "There! You all heard it! I daresay it'll be extremely difficult to find a thief other than the Elf over there. Who if not she would have wanted to steal my Catseyes!?", "Sometimes I really wonder whether you want your gems back, or just the Lady Silverhair convicted!", "Catseyes? You call those worthless shards of yours Catseyes!?", "You doubt my word and expertise? You're truly your mistress' servant! Erek, be so kind and tell our friend here of the stolen gems' nature.", "Master?", "Do as I say!", "Very well. I ... - I will only speak for the stone $name has discovered though. It undoubtedly is a Crysoberyl. However, a Catseye it is not.", "I'd say this calls for an explanation, don't you think so Master Fingolson?", "Oh deary me! It seems, I was mistaken. But even if none of my gems were a Catseye, they'd still remain stolen. So what of it?", "A lie! What is a lie compared to the unsound creations our precious stones are turned into, I ask? Foul workings of magic that contradict anything lawful and good! I wonder who's side you're on, Erek?", "You ..., you think it does not matter? But you've wantonly twisted the truth! You were telling a lie!", "Hold on! You've taken advantage of the theft to bring my mistress into miscredit, because you despise the arcane arts?", "Master Fingolson, if your gems are no Catseyes, you have to see that it's rather unlikely my mistress has stolen them.", "Foolish Half-Elf! Don't you think I'd know best how unlikely it is for anyone, including your fine mistress, to steal these jewels? Were it not for that betrayer you'd never know!", "What are you talking about?", "Then your gems have not been stolen at all?", "Are you too blind to see? It does not matter any more. The hideous Elf will never get what she deserves now, so what should I care?", "So the theft was just pretended!?", ""]
	...
	def __init__(self, p, n):
		...
		self.dialogue = [self.start, self.answer0, self.answer1, self.answer2, self.answer3, self.answer4, self.answer8, self.answer11, self.answer12, self.answer13, self.answer14, self.answer15, self.answer16, self.answer17, self.answer19, self.answer21, self.answer23, None]
