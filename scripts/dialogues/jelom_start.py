class jelom_start:
    ...
    def start (self):
        if the_player.get_val ("at_silverhairs_door") == 1 and quests["demo"].get_val ("know_jelom") != 2:
            ...
            self.cont.append (17)
            if quests["demo"].get_val ("know_talan_singing") == 2 and the_npc.get_val ("not_convinced") == 1:

                self.player.append (43)
                self.cont.append (25)
            if quests["demo"].get_val ("know_olivers_noise") == 1 and the_npc.get_val ("not_convinced") == 0:

                self.player.append (7)
                self.cont.append (4)
            if quests["demo"].get_val ("know_olivers_noise") != 1 and quests["demo"].get_val ("know_talan_singing") != 2:
    ...
    def answer6 (self):
        ...
        if quests["demo"].get_val ("know_talan_singing") == 2 and the_npc.get_val ("not_convinced") == 1:
            ...
            self.player.append (43)
            self.cont.append (25)
        if quests["demo"].get_val ("know_alek_eavesdrop") == 1 and quests["demo"].get_val ("know_olivers_noise") != 1 and quests["demo"].get_val ("know_talan_singing") != 2:

            self.player.append (22)
            self.cont.append (12)
        if quests["demo"].get_val ("ask_packed_gems") == 1 and quests["demo"].get_val ("know_olivers_noise") != 1 and quests["demo"].get_val ("know_talan_singing") != 2:
