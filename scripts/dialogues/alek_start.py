class alek_start:
    ...
    def answer4 (self):
        ...
        self.cont.append (14)
        if not self.eavesdrop and quests["demo"].get_val ("know_alek_eavesdrop"):
