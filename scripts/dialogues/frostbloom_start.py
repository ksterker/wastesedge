class frostbloom_start:
    ...
    def start (self):
        ...
        if the_npc.get_val ("flattered") == 2:
            ...
            self.cont.append (18)
            self.player.append (-1)
        if quests["demo"].get_val ("talked_about_yeti") == 1 and the_npc.get_val ("flattered") == 0:
            ...
            self.cont.append (6)
            self.player.append (-1)
        if the_npc.get_val ("talked_to") == 1 and quests["demo"].get_val ("talked_about_yeti") == 0:
