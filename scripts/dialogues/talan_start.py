class talan_start:
    ...
    def __init__(self):
        self.dialogue = [self.start, self.answer2, self.answer4, self.answer5, self.answer7, self.answer8, self.answer11, self.answer12, self.answer14, self.answer16, self.answer19, self.answer21, self.answer24, self.answer26, self.answer28, self.answer29, self.answer30, self.answer32, self.answer33, self.answer36, self.answer37, self.answer40, self.answer45, self.answer50, self.answer51, self.answer52, self.answer55, self.answer56, self.answer57, self.answer58, self.answer59, self.answer61, self.answer62, self.answer63, self.answer64, self.answer65, self.answer67, self.answer68, self.answer71, self.answer158, None]
    ...
    def start (self):
        if the_npc.get_val( "apologised" ) != 1:
            ...
            self.npc.append (0)
            self.cont.append (-1)
            if quests["demo"].get_val ("know_talan_singing") == 1 and the_npc.get_val ("heard_nothing") == 1:
    ...
    def answer8 (self):
        ...
        if quests["demo"].get_val ("know_olivers_noise") == 1:
            ...
            self.cont.append (37)
        if quests["demo"].get_val ("know_talan_singing") == 1 and quests["demo"].get_val ("know_olivers_noise") != 1:
